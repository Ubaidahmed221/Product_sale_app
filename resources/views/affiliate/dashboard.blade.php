        ...
        <div class="row justify-content-center">
          ...
          <div class="row justify-content-center mt-3">
            <div class="col-md-2">
                <div class="card bg-success text-white text-center p-3" >
                    <h6>Approved</h6>
                    <h4>₨ {{ number_format($totalapprovedPKRCommission, 2) }}</h4>
                </div>
            </div>
             <div class="col-md-2">
                <div class="card bg-warning text-white text-center p-3" >
                    <h6>Pending</h6>
                    <h4>₨ {{ number_format($totalpeddingPKRCommission, 2) }}</h4>
                </div>
            </div>
             <div class="col-md-2">
                <div class="card bg-info text-white text-center p-3" >
                    <h6>Paid</h6>
                    <h4>₨ {{ number_format($totalpaidPKRCommission, 2) }}</h4>
                </div>
            </div>
            </div>
          ...
          <div class="row justify-content-center mt-3">
            <div class="col-md-2">
                <div class="card bg-success text-white text-center p-3" >
                    <h6>Approved</h6>
                    <h4>$ {{ number_format($totalapprovedUSDCommission, 2) }}</h4>
                </div>
            </div>
             <div class="col-md-2">
                <div class="card bg-warning text-white text-center p-3" >
                    <h6>Pending</h6>
                    <h4>$ {{ number_format($totalpeddingUSDCommission, 2) }}</h4>
                </div>
            </div>
             <div class="col-md-2">
                <div class="card bg-info text-white text-center p-3" >
